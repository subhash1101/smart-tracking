"""Load the trained model and turn a mood entry into a stress report."""
...
# Small maps that match the training script.
...
def predict_stress(
    ...
    """Predict stress, burnout, depression risk, confidence, and recommendations."""
    _load()

    # Keep this order in sync with FEATURE_COLS in train_model.py.
    ...
    # Ask the model for the class and confidence.
    ...
    # Depression risk is a simple count of the four signals.
    ...
    # Burnout is rule-based so it stays easy to explain.
    burnout_score = 0
